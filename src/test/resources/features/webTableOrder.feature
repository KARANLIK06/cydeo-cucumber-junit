Feature: Web table user order feature
  ...
  Scenario Template: User should be able to place order and order seen in web table
    ...
    Examples: Famous female scientists
      ...
      | MoneyCog    | 2        | invalidname        | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Marie Curie        |
      | Familybea   | 3        | Rosalind Franklin  | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | Rosalind Franklin  |
      | Screenable  | 4        | invalid name      | London st | London | England | 50505   | Visa     | 1111222233334444 | 12/24   | List Meitner       |
